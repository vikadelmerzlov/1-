...
type ServerInterface interface {
	...
	// Getting information by a specific user id
	// (GET /tasks/{user_id})
	GetTasksByUserID(ctx echo.Context, userId int) error
}
...
func (sh *strictHandler) GetTasksByUserID(ctx echo.Context, userId int) error {
